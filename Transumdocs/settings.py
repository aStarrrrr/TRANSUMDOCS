"""
Django settings for Transumdocs project.
...
SECRET_KEY = 'django-insecure-zqd*w@dw-w9ogf@uo(6nyk9c&jd+-y(8m_k@+@kuxarfe=lob9'
...
WSGI_APPLICATION = 'Transumdocs.wsgi.application'
